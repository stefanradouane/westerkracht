...
export const Mediabank = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const fileNameInput = document.querySelector(".mediabank-form__filename-input");
    ...
    const columns = [
        ...
        { field: 'fileImage', headerName: 'Foto', width: 200, renderCell: (params) => (<img max-width="100%" height="100%" src={params.value}/>)},    
    ]
    ...
    const fileImage = document.querySelector('.mediabank-form__displayed-image')
                ...
                <form method="POST" className="mediabank-form" encType="multipart/form-data" onSubmit={handleSubmit} id="fileForm">
                    ...
                    <section className="mediabank-form__section mediabank-form__section--add">
                        ...
                        <section className="mediabank-form__filename">
                            ...
                            <input className="mediabank-form__filename-input" name="img-name" type="text" placeholder={"imagenaam"}/>

                            <button type="submit" value="add" className="mediabank-form__button mediabank-form__button--add cta" onClick={handleSubmit}>Add file</button>
                    ...
                    <section className="mediabank-form__section mediabank-form__section--remove">
                        ...
                        <button className="mediabank-form__button mediabank-form__button--remove cta" value="remove" onClick={handleSubmit}>Remove file</button>
