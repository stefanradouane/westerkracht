...
const InboxRow = (props) => {
  const { message, useMessage, type } = props;
  ...
  return (
    <section className={"inbox__row inbox__row--" + message.type}>
      ...
      <section className="inbox__row-item inbox__row-item--date">
      ...
      {type === "expanded" && (
        <>
          <section className="inbox__row-item inbox__row-item--control">
            <button
              className="inbox__row-item-control"
              onClick={(e) => {
                collapsible(
                  e.target,
                  e.target.parentElement.nextElementSibling,
                  "inbox__row-item-control--expand"
                );
              }}>
